...
@interface AutomaticVC ()

@end

@implementation AutomaticVC
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        Uimage6.layer.borderWidth=1.5;
        Uimage6.layer.borderColor=[UIColor blackColor].CGColor;
        [self.view addSubview:Uimage6];
