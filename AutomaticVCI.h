...
@interface AutomaticVCI : UIViewController < UIAlertViewDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate,ADBannerViewDelegate,UIActionSheetDelegate,UIPopoverControllerDelegate,SSPhotoCropperDelegate,UIPopoverControllerDelegate> {
